      ...
      <PanelHeader title="文档中心">
        <template #copy>
          <p class="mt-1 text-xs text-muted-foreground">
            当前页面只展示 JoveMage 控制台相关接口、运维边界和风险说明。
          </p>
        </template>
      </PanelHeader>
          ...
          <InfoCard title="动作风险等级" density="roomy">
            <div class="grid gap-3">
              <div
                ...
                :key="risk.level"
                class="flex flex-wrap items-start justify-between gap-3 rounded-sm border border-border bg-muted/20 px-4 py-3"
              >
                <div>
          ...
          <InfoCard title="当前验收状态" density="roomy">
            <div class="grid gap-3 lg:grid-cols-2">
              <div
                ...
                :key="row.scope"
                class="rounded-sm border border-border bg-muted/20 px-4 py-3"
              >
